...
public class TagGroupDaoImpl implements TagGroupDao {
	...
	private static String tag_type_sql = "tag_group_id, tag_group_name, tag_group_create_time, tag_group_remark";

	@Override
	public TagGroup getTagGroupByName(String tagGroupName) {
		String sql = "select "+tag_type_sql+" from t_tag_type where 1=1 and tag_group_name=?";
